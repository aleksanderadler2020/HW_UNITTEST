...
for id, _ in enumerate(courses_list):
    ...
    if durations_dict.get(key) == None:
        durations_dict[key] = [courses[id]]
    else:
        durations_dict[key].append(courses[id])
...
def check_dict(sort_list):
    sort_list = list(sort_list.items())
    return (sort_list[0][0] == 12) and (sort_list[1][0] == 14) and (sort_list[2][0] == 20)
