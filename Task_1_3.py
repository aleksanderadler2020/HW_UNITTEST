...
def link_course(course1, course2):
	if type(course1) == dict or type(course2) == dict:
		raise TypeError
	return course1 == course2

print("Связь есть" if link_course(indexes_d, indexes_m) else "Связи нет")
