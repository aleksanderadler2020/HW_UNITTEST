...
for course_dict in zip(courses, mentors, durations):
    course_dict = {'title': course_dict[0], 'mentors': course_dict[1], 'duration': course_dict[2]}
...
def is_short_course(course):
    return course == "Python-разработчик с нуля"


def is_long_course(course):
    return course in ["Fullstack-разработчик на Python", "Frontend-разработчик с нуля"]